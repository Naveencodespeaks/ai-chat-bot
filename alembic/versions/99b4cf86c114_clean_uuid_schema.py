...
Revision ID: 99b4cf86c114
Revises: 
Create Date: 2026-02-18 12:21:49.036997
...
def upgrade() -> None:
    ...
    op.alter_column('sentiment_logs', 'user_id',
               ...
               type_=sa.String(length=255),
               existing_nullable=False)
    op.alter_column('tickets', 'conversation_id',
               existing_type=sa.INTEGER(),
               type_=sa.String(length=255),
               existing_nullable=False)
    ...
    op.add_column('user_roles', sa.Column('role_name', sa.String(length=100), nullable=False))
